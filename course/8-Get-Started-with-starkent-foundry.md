إليك النسخة المعدلة من ملف `README.md` مع تحسينات على تنسيق الأوامر لتكون أسهل للنسخ:
...
- تم تحسين تنسيق الأوامر باستخدام كتل كود (` ```bash `) لتسهيل نسخ الأوامر من الملف.
- تم الحفاظ على التنسيق العربي والتوجه من اليمين إلى اليسار.
